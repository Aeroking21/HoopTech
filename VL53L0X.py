...
class VL53L0X(object):
    ...
    def calibrate(self, timing, distance):
        """Calibrate distance of hoop"""
        ...
        avg_distance = total_distance/(count-1)
        print("Done calibrating - boundary = ", avg_distance)

        return avg_distance

    def detect(self, distance, boundary, score):
        """Detect baskets made"""
